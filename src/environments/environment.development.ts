export const environment = {
    ...
    config: {
      fromTokenValid:
        'https://development.auth-core.webproductionlabs.com/api/login',
    ...
    interop: {
      basePath: 'https://development.urb-core.webproductionlabs.com/',
      urbanism: {
        settings: {
          configurations: {
      ...
      authCore: {
        basePath: 'https://development.auth-core.webproductionlabs.com/',
